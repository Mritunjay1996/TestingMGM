...
class ListDetails():
    ...
    toggledemo = (By.XPATH, "//span[contains(text(),'movietest" + randNumber + "')]/preceding-sibling::span[1]")
    mylist = (By.XPATH, "//ul[@class='menu-items']//a[@id='My Lists']")
    listele = (By.XPATH, "//a[contains(text(),'movietest" + randNumber + "')]")
    ...
    autoselect = (By.XPATH, "//span[contains(text(),'autodetailtest" + randNumber + "')]/preceding-sibling::input[1]")
    createdlist = (By.XPATH, "//a[contains(text(),'autodetailtest" + randNumber + "')]")
    ...
    deletecreatelist = (By.XPATH,
                        "//a[contains(text(),'autodetailtest" + randNumber + "')]/ancestor::div[@class='col-lg-5 listData']/following-sibling::div[2]/button[2]")
    ...
    added_movie = (By.XPATH, "//span[contains(text(),'movietest" + randNumber + "')]")
    added_movie_list = (By.XPATH, "//span[contains(text(),'autodetailtest" + randNumber + "')]")
    ...
    def verify_addmovietolist(self):
        ...
        time.sleep(1)
        self.browser.find_element(*self.mylistname).send_keys("movietest" + randNumber)
    ...
    def verify_createlist(self):
        ...
        self.browser.find_element(*self.mylistname).click()
        time.sleep(1)
        self.browser.find_element(*self.mylistname).send_keys("autodetailtest" + randNumber)
        self.browser.find_element(*self.createlistbutton).click()
        WebDriverWait(self.browser, 50).until(EC.presence_of_element_located(self.success_created_list))
