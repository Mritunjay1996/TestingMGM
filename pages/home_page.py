...
class homePageObj:
    ...
    watch_movie = (By.XPATH, "//h2[contains(text(),'Action / Adventure')]/ancestor::div[3]/following-sibling::div//ul/li[3]//button[contains(text(),'Watch movie')]")
    ...
    watchmovie_name = (By.XPATH, "//h2[contains(text(),'Action / Adventure')]/ancestor::div[3]/following-sibling::div//ul/li[3]//div[@class='movie-poster']//div[3]/p[1]")
    ...
    cardhover_option1 = (By.XPATH, "(//h2[contains(text(),'Recently Watched')]/ancestor::div[3]/following-sibling::div[1]//li//button[contains(text(),'ADD TO LIST')])[1]")
    cardhover_option2 = (By.XPATH, "(//h2[contains(text(),'Recently Watched')]/ancestor::div[3]/following-sibling::div[1]//li//button[contains(text(),'Watch movie')])[1]")
    cardhover_option3 = (By.XPATH, "(//h2[contains(text(),'Recently Watched')]/ancestor::div[3]/following-sibling::div[1]//li//button[contains(text(),'Watch trailer')])[1]")
    cardhover_option4 = (By.XPATH, "(//h2[contains(text(),'Recently Watched')]/ancestor::div[3]/following-sibling::div[1]//li//button[contains(text(),'View details')])[1]")
    ...
    def verify_pagetitle(self):
        time.sleep(2)
        WebDriverWait(self.browser, 15).until(EC.presence_of_element_located(self.title_overview))
    ...
    def verifyMovie_list(self, movie):
        time.sleep(2)
        WebDriverWait(self.browser, 30).until(EC.presence_of_element_located((By.XPATH, "//div[@class='desk-on']//p[@class='movie-title light-color'][contains(text(),'" + str(movie) + "')]")))
        time.sleep(3)
