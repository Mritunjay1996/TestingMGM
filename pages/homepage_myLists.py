...
class homePagemylistsObj:
    ...
    demo_check = (By.XPATH, "//div[p[text()='Your Lists']]/following-sibling::div[1]/div[3]//mgm-checkbox-single["
                            "1]/div[1]/input[1]")
    list_selected = (By.XPATH, "//div[@class='item-actions']/span[1]")
    download = (By.XPATH, "//span[contains(text(),'DOWNLOAD.CSV')]")
    download_footer = (By.XPATH, "//button[contains(text(),'DOWNLOAD .XLSX')]")
    share_popup_footer = (By.XPATH, "//button[span[contains(text(),'EMAIL .XLSX')]]")
    share_popup = (By.XPATH, "//span[contains(text(),'SHARE LIST')]")
    share_title = (By.XPATH, "//span[contains(text(),'SHARE TITLE')]")
    delete_popup_footer = (By.XPATH, "//button[contains(text(),'DELETE')]")
    ...
    def click_Createdlist(self):
        WebDriverWait(self.browser, 30).until(EC.presence_of_element_located(self.user_created))
