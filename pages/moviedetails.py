...
class moviedetails():
    ...
    addtolistmovie = (By.XPATH, "//span[contains(text(),'movietest" + randNumber + "')]/preceding-sibling::span[1]")
    addmovietolist = (By.XPATH, "//div[@class='atl-newlistbox']/button/span")
    mylist = (By.XPATH, "//ul[@class='menu-items']//a[@id='My Lists']")
    titleinlist = (By.XPATH, "//a[contains(text(),'movietest" + randNumber + "')]")
    verifytitlelist = (
    ...
    movieTest_List_delete = (By.XPATH, "//a[contains(text(),'movietest" + randNumber + "')]/ancestor::div[2]/following-sibling::div[2]/button[2]")
