...
class recaddListObj:
    ...
    def verify_LoaderText(self):
        ...
        WebDriverWait(self.browser, 20, ignored_exceptions).until(EC.presence_of_element_located(self.loader_text))
    ...
    def verify_newCreatedlist(self):
        WebDriverWait(self.browser, 60).until(EC.presence_of_element_located(self.new_created))
    ...
    def verify_automation_Createdlist(self):
        WebDriverWait(self.browser, 60).until((EC.presence_of_element_located(self.automation_created)))
    ...
    def verify_success_msg(self):
        # ignored_exceptions = (NoSuchElementException, StaleElementReferenceException,)
        WebDriverWait(self.browser, 60).until(EC.presence_of_element_located(self.success_created)) #ignored_exceptions
    ...
    def verify_delete_Createdlist(self):
        WebDriverWait(self.browser, 60).until((EC.presence_of_element_located(self.delete_created)))
    ...
    def verify_success_created_list(self):
        WebDriverWait(self.browser, 60).until(EC.presence_of_element_located(self.success_created_list))
