...
def test_MoreThan4Titles(browser):
    home.ClickLogo()
    time.sleep(3)
    if home.test_count_carousel() > 4:
        assert home.ProgressBarLegallyBlonde() == True, "Auto Progress is not working when main carousel has more " \
                                                        "than 4 movies. "
    else:
        assert home.ProgressBarLegallyBlonde() == True, "Auto Progress is working when main carousel has less than or " \
                                                        "equal of 4 movies. "


@allure.title('TC_022: Verify the Title is underlined(highlighted) when carousel moves to that slider')
...
@allure.title('TC_012: Verify on click of Roar logo in header user is redirected to Homepage')
...
#     # home.ClickMainCarouselAddToList()
#     time.sleep(2)
#     home.SearchList("test" + randNumber)
...
#     home.ListName("test1" + randNumber)
...
#     assert list == True
#     time.sleep(2)
#     home.ListName("test2" + randNumber)
#     home.ClickCreateList()
#     assert list == True
#     created = home.CreatedList()
#     assert created == True
...
#     home.Refresh()
#     home.ClickMovieCardAddToList()
#     home.SearchList("test2" + randNumber)
#     time.sleep(2)
...
#     home.ClickAddToListClearButton()
#     home.SearchList("test1" + randNumber)
#     time.sleep(2)
...
#     time.sleep(3)
#     add_list.enter_Listname(automation_listt)
#     time.sleep(2)
#     add_list.click_createList_text()
#     assert add_list.verify_LoaderText() == "Creating...", "After clicking on create list button Loader is not " \
#                                                           "displaying. "
#     time.sleep(2)
#     assert add_list.verify_success_created() == True, "Success message is not showing after creating new List. "
#     assert add_list.verify_automation_Createdlist() == automation_listt, "After Creating new List . It is not displaying in pop up"
#     time.sleep(2)
#     assert add_list.verify_autoList_checkBox() == True, "Newly created list is not auto selected. "
#     add_list.click_automationList_toUNsel()
...
#                                                           "not opening. "
#     time.sleep(2)
#     select.enter_listname_search(automation_listt)
#     time.sleep(3)
...
#     assert movie.verify_Clearbutton() == "Search cleared", "After clicking on clear button search result is not clear."
#     movie.enter_listname_search(new_List_name)
#     time.sleep(2)
...
#     assert elements.verify_userCreated_list() == automation_listt, "User created list with name Automation List is " \
...
#     assert list.verify_userCreated_list() == automation_listt, "Automation List title is not showing in heading . It " \
#                                                                "should show. "
...
# @allure.title('TC_138: Verify clicking on Delete button, Delete pop up is shown')
...
#     assert add_list.verify_delete_Createdlist() == delete_listtt, "After Creating new List . It is not displaying in pop up"
#     time.sleep(2)
#     add_list.click_Addlist_button()
#     assert add_list.verify_success_msg() == True, "Success message (Done) is not showing after creating new List. "
#     time.sleep(2)
...
#     sections.refresh()
#     assert sections.verify_tv_pagetitle() == "ROAR | Vikings (series)", "After Clicking on view detail, Detailed page " \
#                                                                         "is not opening . "
...
# @pytest.mark.xfail(reason="may fail due to data issues from backend")
...
#     time.sleep(2)
#     assert elements.verify_episode1Detailed() == "EPISODE 1 :", "After clicking of episode number episode detailed " \
#                                                                 "page is not opening "
...
# @allure.title('Delete all created list')
# def test_delete_createdList(browser):
#     home_page = homePagemylistsObj(browser)
#     delete = myListObj(browser)
#     listpage.click_mylistTab()
#     time.sleep(2)
#     listpage.click_demoDel()
#     listpage.click_testDel()
#     listpage.click_test1Del()
#     listpage.click_test2Del()
#     home_page.click_automationList_toDel()
#     delete.click_grant_delete()
...
#     listdet.verify_shareemail()
#     assert listdet.verify_share_confirmation() == True, "After clicking on share button , confirmation is not showing."
...
#     global listdet
#     listdet = ListDetails(browser)
#     listdet.verify_sharelistheader()
#     assert listdet.verify_share_confirmation() == True, "After clicking on share button , confirmation is not showing."
...
# @allure.title('TC_017: Verify Watch Now button is clickable and on click of it opens playout pop up')
...
# def test_deleteMovietestList(browser):
#     movie_det = moviedetails(browser)
#     listpage.click_mylistTab()
#     time.sleep(2)
#     movie_det.test_del_movietest()
